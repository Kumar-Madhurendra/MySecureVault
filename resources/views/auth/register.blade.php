...
<style>
    ...
    body.light-mode .alert-info .alert-link {
        color: #2563eb;
    }
...
<div class="register-container">
    <div class="card card-custom">
        <div class="text-center">
            <img src="https://cdn-icons-png.flaticon.com/512/1177/1177568.png" alt="Register Icon" class="register-image">
        </div>
        ...
        <div class="card-body">
            ...
            <div class="alert alert-info alert-dismissible fade show">
                ...
                <a href="{{ route('password.request') }}" class="alert-link">Reset</a>
            ...
            <form method="POST" action="{{ route('register') }}" class="compact-form">
                ...
                <div class="mb-3">
                    <label for="password-confirm" class="form-label">{{ __('Confirm') }}</label>
            ...
            <div class="login-link">
                {{ __('Have an account?') }} <a href="{{ route('login') }}">{{ __('Sign in') }}</a>
            </div>
        </div>
    </div>
</div>
